...
from code import FresnoDailyNews_pb2 as FresnoDailyNews__pb2
...
class FresnoDailyNews(object):
    ...
    def ExtractKeyword(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/fresnodailynews.FresnoDailyNews/ExtractKeyword',
